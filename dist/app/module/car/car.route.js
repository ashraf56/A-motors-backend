...
router.put('/:id', (0, authGuard_1.default)('admin'), (0, validateRequest_1.default)(car_validation_1.CarValidatons.updateAcarValidationSchema), car_controller_1.CarContoller.deleteSingleCarController);
